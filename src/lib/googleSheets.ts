...
const SHEET_HEADER_ROW = [
  ...
  // Garment 1
  'Garment1 Category', 'Garment1 Variant', 'Garment1 Urgency', 'Garment1 Quantity', 'Garment1 Design Description', 'Garment1 Canvas Image Link', 'Garment1 Design Reference Links', 'Garment1 Voice Note Link',
  ...
  // Garment 2
  'Garment2 Category', 'Garment2 Variant', 'Garment2 Urgency', 'Garment2 Quantity', 'Garment2 Design Description', 'Garment2 Canvas Image Link', 'Garment2 Design Reference Links', 'Garment2 Voice Note Link',
  ...
  // Garment 3
  'Garment3 Category', 'Garment3 Variant', 'Garment3 Urgency', 'Garment3 Quantity', 'Garment3 Design Description', 'Garment3 Canvas Image Link', 'Garment3 Design Reference Links', 'Garment3 Voice Note Link',
