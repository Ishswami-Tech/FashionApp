              ...
              >
                ...
                <div className="absolute inset-0 flex items-center justify-center text-gray-700">
                  <div className="text-center transform group-hover:scale-110 transition-transform duration-500">
                    <Sparkles className="w-8 h-8 mx-auto mb-3 group-hover:text-rose-600 transition-colors duration-300" />
                    <p className="font-semibold group-hover:text-rose-600 transition-colors duration-300">
                      Design {item}
                    </p>
                  </div>
                </div>
      ...
      <section id="contact" className="py-32 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              {[
                {
                  ...
                  desc: "Premium consultation & fitting experience",
                  color: "from-rose-500 to-pink-500",
                },
                {
                  icon: <Phone className="w-6 h-6" />,
                  title: "Call Us",
                  desc: "Instant response for urgent needs",
                  color: "from-purple-500 to-violet-500",
                },
                {
            ...
            >
              <div className="backdrop-blur-xl bg-white/90 rounded-3xl p-8 border border-gray-200/50 relative overflow-hidden shadow-lg hover:shadow-xl transition-all duration-500">
                {/* Animated Background Gradient */}
                ...
                <div className="relative z-10 space-y-6">
                  ...
                  <button
                    type="button"
                    className="group relative w-full bg-gradient-to-r from-rose-500 via-pink-500 to-purple-500 text-white py-4 rounded-2xl font-bold text-lg hover:from-rose-600 hover:via-pink-600 hover:to-purple-600 transform hover:scale-105 hover:-translate-y-1 transition-all duration-500 shadow-lg hover:shadow-xl overflow-hidden"
                    onClick={() =>
                      alert(
                        "✨ Thank you for your interest! We'll be in touch soon to discuss your dream outfit!"
                      )
                    }
                  >
                    <div className="absolute inset-0 bg-gradient-to-r from-rose-600 via-pink-600 to-purple-600 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-4">
              Crafting dreams into designer reality since 2019
            </p>
